...
import pymongo
import os
from cnnb.settings import mongo_host, mongo_port, mongo_user, mongo_passwd, mongo_db_name, mongo_db_collection


class CnnbPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        with open(self.path + path + "/" + data["title"] + '.txt', 'w') as f:
            f.write(data["text"])
            f.close()
        return item
